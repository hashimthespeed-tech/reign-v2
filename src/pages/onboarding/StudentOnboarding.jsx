  ...
  return (
    <OnboardingShell>
      <Card style={{ padding: 36, textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 23, fontWeight: 800, letterSpacing: '-0.02em' }}>
          Your request is in
        </h2>
...
function RevealStep({ onDone }) {
  ...
  return (
    <OnboardingShell>
      <Card glow style={{ padding: 40, textAlign: 'center' }}>
        <div style={{ marginBottom: 18 }}><Logo size={22} /></div>
        <h2 style={{ fontSize: 26, fontWeight: 800, letterSpacing: '-0.02em' }}>You're in.</h2>
        <p style={{ color: colors.textMuted, marginTop: 10 }}>Taking you to your dashboard…</p>
      </Card>
    </OnboardingShell>
  )
}
